...
class DimenFixTSNE(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    def __init__(
        ...
        *,
        ...
        self.alpha = alpha
        self.pulling_strategy = pulling_strategy
        self.iterations_to_pull = iterations_to_pull
    ...
    def _fit(self, X, skip_num_points=0):
        ...
        # init DimenFix
        dfix = DimenFix(feature_type=self.feature_type,
                        pulling_strategy=self.pulling_strategy,
                        alpha=self.alpha).fit(X_embedded, self.fixed_feature)
    ...
    def _tsne(
        ...
        opt_args = {
            ...
            "momentum": 0.5,
            "dimenfix": dimenfix,
            "iterations_to_pull": self.iterations_to_pull
            #
            # "fixed_feature": self.fixed_feature,
